...
// BytesToUint64 is convert from bytes to uint64
func BytesToUint64(b []byte) uint64 {
	return uint64(b[7]) | uint64(b[6])<<8 | uint64(b[5])<<16 | uint64(b[4])<<24 |
		uint64(b[3])<<32 | uint64(b[2])<<40 | uint64(b[1])<<48 | uint64(b[0])<<56
}

// BytesToUint32 is convert from bytes to uint32
func BytesToUint32(b []byte) uint32 {
	return uint32(b[3]) | uint32(b[2])<<8 | uint32(b[1])<<16 | uint32(b[0])<<24
}

// BytesToUint16 is convert from bytes to uint16
func BytesToUint16(b []byte) uint16 {
	return uint16(b[1]) | uint16(b[0])<<8
}

// Bytes16ToUint32 is convert from bytes16 to uint32
func Bytes16ToUint32(b []byte) uint32 {
	return uint32(b[1]) | uint32(b[0])<<8
}

// Uint64ToBytes is convert from uint64 to bytes
...
// Uint32ToBytes is convert from uint32 to bytes
...
// Uint16ToBytes is convert from uint16 to bytes
...
// UintToBytes is convert from uint to bytes
...
// BytesToUint is convert from bytes to uint
